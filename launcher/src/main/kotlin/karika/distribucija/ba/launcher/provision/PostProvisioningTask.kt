...
import karika.distribucija.ba.launcher.provision.LauncherDeviceAdminReceiver.Companion.getComponentName
...
class PostProvisioningTask(private val mContext: Context) {
    ...
    val postProvisioningLaunchIntent: Intent
        get() {
            val launch = Intent(mContext, FinalizeActivity::class.java)
