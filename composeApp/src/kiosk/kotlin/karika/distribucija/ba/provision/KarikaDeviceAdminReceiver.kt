...
class KarikaDeviceAdminReceiver : DeviceAdminReceiver() {
    ...
    companion object {
        ...
        fun getComponentName(context: Context): ComponentName? {
            return if (Util.isDeviceOwner(context) || Util.isProfileOwner(
                    context
                )
            ) {
        ...
        fun getReceiverComponentName(context: Context): ComponentName {
            return ComponentName(context.applicationContext, KarikaDeviceAdminReceiver::class.java)
        }
    }
}
