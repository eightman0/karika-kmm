...
/** Mirrors composeApp's domain/model/StaffThread.kt - staff-to-staff internal messaging. */
@Serializable
...
@Serializable
data class StaffStartThread(val request: StaffStartThreadRequest)
...
@Serializable
data class StaffSendMessage(val request: StaffSendMessageRequest)
